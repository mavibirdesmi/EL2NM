...
from .modules import ConvBlock3d
...
class Unet3d(nn.Module):
    def __init__(self, n_channel_in=1, n_channel_out=1, residual=False, down='conv', up='tconv', activation='selu'):
        ...
        self.conv4 = ConvBlock3d(128, 256, residual, activation)

        self.conv5 = ConvBlock3d(256, 256, residual, activation)
        ...
        if self.residual:
            self.convres = ConvBlock3d(n_channel_in, n_channel_out, residual, activation)
